...
public class Server {
	...
	/**
	 * constructor of the Server class, it will designate port 9070 as the
	 * service port
	 * 
	 * @throws IOException
	 */
	public Server() throws IOException {
		SSLServerSocketFactory sslserversocketfactory = (SSLServerSocketFactory) SSLServerSocketFactory
				.getDefault();
		sslserversocket = (SSLServerSocket) sslserversocketfactory.createServerSocket(Server.PORT);
	}
	...
	/**
	 * the server will start to provide services, the method will create a
	 * connection handler that deal with all clients'connections
	 */
	public void service() {
		ConnectionHandler handler = new ConnectionHandler(sslserversocket);
		handler.start();
	}
}
